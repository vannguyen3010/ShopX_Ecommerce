...
namespace Ecommerce_Wolmart.API.Migrations
{
    ...
    [Migration("20241216062237_Status ShippingCost")]
    partial class StatusShippingCost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Identity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "8c506b39-246b-4cf3-8c6c-ae518250ce79",
                            CreateAt = new DateTime(2024, 12, 16, 6, 22, 35, 735, DateTimeKind.Utc).AddTicks(4662),
                            Email = "superadmin@gmail.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "SUPERADMIN@GMAIL.COM",
                            NormalizedUserName = "NGUOIDEV",
                            PasswordHash = "AQAAAAIAAYagAAAAECUPed2NV98tJ/N+Dl/7PGjVeRxB8G/1u5XCTdqDmj0X0I4beKAPudZ5myzA5HAZQQ==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "",
                            TwoFactorEnabled = false,
                            UpdateAt = new DateTime(2024, 12, 16, 6, 22, 35, 735, DateTimeKind.Utc).AddTicks(4662),
                            UserName = "NguoiDev"
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.Banner", b =>
                {
                    ...
                    b.Property<string>("SecondFileExtension")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SecondFileName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SecondFilePath")
                        .HasColumnType("nvarchar(max)");

                    b.Property<long?>("SecondFileSizeInBytes")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Entities.Models.ShippingCost", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Entities.Models.SocialMediaInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Entities.Identity.UserRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "675a9368-d9f3-49cb-bb9b-2aa3996e82ee",
                            Name = "SuperAdmin",
                            NormalizedName = "SUPERADMIN",
                            DateCreated = new DateTime(2024, 12, 16, 6, 22, 35, 735, DateTimeKind.Utc).AddTicks(4309)
                        },
                        new
                        {
                            Id = "aee97786-ccb7-4e17-855e-0d427cc40a85",
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            DateCreated = new DateTime(2024, 12, 16, 6, 22, 35, 735, DateTimeKind.Utc).AddTicks(4324)
                        },
                        new
                        {
                            Id = "f91634ba-4d28-4e11-bba3-37130923316e",
                            Name = "User",
                            NormalizedName = "USER",
                            DateCreated = new DateTime(2024, 12, 16, 6, 22, 35, 735, DateTimeKind.Utc).AddTicks(4328)
                        });
                });
            ...
            modelBuilder.Entity("Entities.Models.Introduce", b =>
                {
                    b.HasOne("Entities.Models.CategoryIntroduce", "CategoryIntroduce")
                        .WithMany("Introduces")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CategoryIntroduce");
                });
